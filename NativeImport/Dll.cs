...
namespace NativeImport {
    ...
    public class NativeDll {
        ...
        [DllImport(dll)] public static extern void CopyImageBufferZoom(IntPtr sbuf, int sbw, int sbh, IntPtr dbuf, int dbw, int dbh, int panx, int pany, float zoom, bool clear);
    }
}
