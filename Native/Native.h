...
BOOL Loa8BitGrayBmp(BYTE* buf, int bw, int bh, char* filePath);
void CopyImageBuf(BYTE* srcBuf, int srcBW, int srcBH, BYTE* dstBuf, int dstBW, int dstBH, int offsetX, int offsetY);